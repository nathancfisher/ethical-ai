function Logo() {
  return (
    <span className="align flex items-center gap-2.5 sm:gap-4">
      <svg
        viewBox="0 0 200 200"
        fill="none"
      ...
      >
        ...
        <defs>
          ...
          >
            {" "}
            <stop stopColor="oklch(62.3% 0.214 259.815)" />{" "}
            <stop offset="1" stopColor="oklch(62.3% 0.214 259.815)" />{" "}
          </linearGradient>{" "}
      ...
      <p className="text-2xl font-semibold tracking-tight text-neutral-800 sm:text-4xl">
        EthicalAI
      </p>
    </span>
  );
